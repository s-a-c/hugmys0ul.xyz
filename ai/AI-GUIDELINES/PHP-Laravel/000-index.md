# <a id="php-laravel-index"></a>PHP-Laravel Development Standards Index
...
- **PHPStan Level 10**: Maximum static analysis compliance and type safety
...
- **Static Analysis**: PHPStan Level 10 compliance for all production code
...
- **Static Analysis**: PHPStan Level 10 compliance enforcement
...
- **Code Quality**: Ensure PHPStan Level 10 compliance and proper testing
...
- **Static Analysis**: Include PHPStan compliance in quality checks
...
**← Previous:** [Templates Index](../Documentation/060-templates/000-index.md) | **Next →** [Project Overview](010-project-overview.md) | **Top**
