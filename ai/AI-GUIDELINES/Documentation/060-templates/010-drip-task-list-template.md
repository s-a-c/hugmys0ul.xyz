# <a id="drip-task-list-template"></a>DRIP Task List Template
...
**← Previous:** [Templates Index](000-index.md) | **Next →** [Documentation Template](020-documentation-template.md) | **Top**
