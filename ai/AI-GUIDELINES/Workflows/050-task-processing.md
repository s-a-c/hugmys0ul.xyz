# <a id="task-processing"></a>Task Processing Workflow
...
**← Previous:** [Task Generation Workflow](040-task-generation.md) | **Next →** [Shell-CLI Index](../Shell-CLI/000-index.md) | **Top**